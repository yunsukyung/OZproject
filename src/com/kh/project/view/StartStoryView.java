...
public class StartStoryView extends JPanel{
	...
	public static void main(String[] args) {
		...
		Image icon = new ImageIcon("C:\\Users\\s\\git\\OZproject\\src\\image\\start\\스토리 배경.jpg").getImage().getScaledInstance(570, 760, 0);
		JLabel label = new JLabel(new ImageIcon(icon));


		Image penguin = new ImageIcon("C:\\Users\\s\\git\\OZproject\\src\\image\\start\\놀라는 펭귄.gif").getImage().getScaledInstance(200, 200, 0);
		JLabel label2 = new JLabel(new ImageIcon(penguin));
		label2.setLocation(210, 310);
		label2.setSize(200, 200);
		
		Image text = new ImageIcon("C:\\Users\\s\\git\\OZproject\\src\\image\\start\\대화창.png").getImage().getScaledInstance(350, 170, 0);
		JLabel label3 = new JLabel(new ImageIcon(text));
		label3.setLocation(100, 480);
		label3.setSize(350, 300);
		label3.setText("여기가어디지?");
		
		Image next = new ImageIcon("C:\\Users\\s\\git\\OZproject\\src\\image\\start\\화면넘기기.png").getImage().getScaledInstance(30, 40, 0);
