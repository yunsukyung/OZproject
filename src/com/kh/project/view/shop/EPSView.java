...
public class EPSView extends JPanel{
	...
	public EPSView(MainView mf) {
		...
		//상점 레이어 8
		JLabel label8 = new JLabel(new ImageIcon(new ImageIcon("src/image/start/화폐창.png").getImage()));
		label8.setBounds(118, 425, 130, 70);
		
		//상점 레이어 9 (쓰레기통 작은아이콘)
		JLabel label9 = new JLabel(new ImageIcon(new ImageIcon("").getImage().getScaledInstance(25, 25, 0)));
		label9.setBounds(200, 400, 18, 18);
