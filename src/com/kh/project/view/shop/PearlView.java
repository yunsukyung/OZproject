...
public class PearlView extends JPanel{
	...
	public PearlView(MainView mf, Player p) {
		...
		//상점 레이어 5
		JLabel label5 = new JLabel(new ImageIcon(new ImageIcon("src/image/start/진주2.png").getImage().getScaledInstance(155, 155, 0)));
		label5.setBounds(35, 160, 300, 300);
		
		//상점 레이어 6
		JLabel label6 = new JLabel(new ImageIcon(new ImageIcon("src/image/start/Rectangle 35.png").getImage()));
		label6.setBounds(135, 370, 100, 50);
		...
		//상점 레이어 8
		JLabel label8 = new JLabel(new ImageIcon(new ImageIcon("src/image/start/Component 4.png").getImage()));
		label8.setBounds(118, 425, 130, 70);
		
		//상점 레이어 9
		JLabel label9 = new JLabel(new ImageIcon(new ImageIcon("src/image/start/진주2.png").getImage().getScaledInstance(25, 25, 0)));
		label9.setBounds(150, 375, 30, 30);
		...
		//진주 텍스트
		JLabel pearl = new JLabel("X 10");
		pearl.setBounds(182, 367, 50, 50);
		JTextField tf2 = new JTextField(10);
		tf2.setBounds(50, 50, 50, 50);
		
		//현질 텍스트
		JLabel money = new JLabel("₩ 1,200");
		money.setBounds(170, 435, 50, 50);
