...
public class FoodView extends JPanel{
	...
	public FoodView(MainView mf) {
		...
		//상점 레이어 5
		JLabel label5 = new JLabel(new ImageIcon(new ImageIcon("src/image/start/fish.png").getImage().getScaledInstance(155, 155, 0)));
		...
		//상점 레이어 9 (쓰레기통 작은아이콘)
		JLabel label9 = new JLabel(new ImageIcon(new ImageIcon("src/image/start/heartbeat.png").getImage().getScaledInstance(25, 25, 0)));
		label9.setBounds(147, 374, 25, 25);
		...
		//상품 기능 텍스트
		JLabel pearl = new JLabel(" X 25");
		pearl.setBounds(180, 374, 47, 25);
		JTextField tf2 = new JTextField(10);
		tf2.setBounds(50, 50, 50, 50);
		
		//물물교환 텍스트
		JLabel money = new JLabel("30");
