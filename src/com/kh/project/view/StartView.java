...
public class StartView extends JPanel {
	...
	File file = new File("src\\com\\kh\\project\\bgm\\게임시작_회원가입_로그인화면-대빙하.wav");
	...
	MusicPlayer.MusicStart("src\\com\\kh\\project\\bgm\\게임시작_회원가입_로그인화면-대빙하.wav");
	...
	OZ.setFont(new Font("궁서체", Font.BOLD, 35));
	...
	OZ1.setFont(new Font("궁서체", Font.BOLD, 38));
